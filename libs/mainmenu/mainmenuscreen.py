class MainMenuScreen:
	...
	def drawscreen(self):
		...
		self.screen.addstr(13, 4, "aws          - Amazon AWS...")
		self.screen.addstr(14, 4, "xss          - XSS...")
		self.screen.addstr(16, 4, "debug        - toggle debug on/off")
		self.screen.addstr(17, 4, "proxy        - set proxy settings...")
		self.screen.addstr(18, 4, "!sh          - escape to unix land...")
		self.screen.addstr(20, 4, "quit         - Exit webnuke")
